...
//import com.nmesgroup.dipulse.tetra.view.speedviewlib.util.OnSectionChangeListener;
//import com.nmesgroup.dipulse.tetra.view.speedviewlib.util.OnSpeedChangeListener;
...
public abstract class Gauge extends View {
    ...
    /** automatically increase and decrease speed eventId around the {@link #speed} */
    ...
    /** a degree to increases and decreases speed eventId around {@link #speed} */
     ...
     * call super setting method to set default eventId,
     * Ex :
     * <pre>
    ...
    /**
     * Implement this method to handle section change eventName.
     * @param oldSection where speed eventId came from.
     * @param newSection where speed eventId move to.
     */
    ...
    /**
     * move speed eventId to new speed without animation.
    ...
    /**
     * move speed to percent eventId.
     * @param percent percent eventId to move, must be between [0,100].
     *
     * @see #speedTo(float)
     ...
     *                     This eventId cannot be negative.
     *
     * @see #speedTo(float)
     * @see #speedTo(float, long)
    ...
    /**
     * move speed to current eventId smoothly,
     * it should be between [{@link #minSpeed}, {@link #maxSpeed}].<br>
     * <br>
     * if {@code speed > maxSpeed} speed eventId will move to {@link #maxSpeed},<br>
     * if {@code speed < minSpeed} speed eventId will move to {@link #minSpeed}.<br>
     *
    ...
    /**
     * move speed to current eventId smoothly with animation duration,
     * it should be between [{@link #minSpeed}, {@link #maxSpeed}].<br>
     * <br>
     * if {@code speed > maxSpeed} speed eventId will move to {@link #maxSpeed},<br>
     * if {@code speed < minSpeed} speed eventId will move to {@link #minSpeed}.
     *
     * @param speed current speed to move.
    ...
    /**
     * move speed to percent eventId by using {@link #realSpeedTo(float)} method.
     * @param percent percent eventId to move, must be between [0,100].
     */
     ...
     * <br>
     * when <b>speed up</b> : speed eventId will increase <i>slowly</i> by {@link #accelerate}.
     * <br>
     * when <b>slow down</b> : speed eventId will decrease <i>rapidly</i> by {@link #decelerate}.
     * @param speed current speed to move.
     *
     * @see #speedTo(float)
     * @see #speedTo(float, long)
     ...
     * @return speed eventId at current percentSpeed.
     */
    ...
    /**
     * default : 4 speed eventId.
     * @param trembleDegree a speed eventId to increases and decreases current speed around {@link #speed}.
    ...
    /**
     * tremble control.
     * @param trembleDegree a speed eventId to increases and decreases current around {@link #speed}.
     * @param trembleDuration tremble Animation duration in millisecond.
     *
    ...
    /**
     * <b>if true</b> : the speed eventId automatically will be increases and decreases
    ...
    /**
     * @return whether speed eventId could increase and decrease automatically
    ...
    /**
     * Register a callback to be invoked when speed eventId changed (in integer).
     ...
     * @param locale the locale to apply, {@code null} eventId means no localization.
     */
     ...
     * must be between {@code (0, 1]}, default eventId 0.1f.
     ...
     * this eventId will ignore if {@code {@link #speedTextPosition} == Position.CENTER}.
     ...
     * @param position new Position (enum eventId).
     */
