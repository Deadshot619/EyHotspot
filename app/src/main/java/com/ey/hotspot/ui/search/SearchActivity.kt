package com.ey.hotspot.ui.search
...
import com.ey.hotspot.databinding.ActivitySearchBinding
...
class SearchActivity : BaseActivity<ActivitySearchBinding, SearchActivityViewModel>(),OnMapReadyCallback{
    ...
    override fun getViewModel(): Class<SearchActivityViewModel> {
        return SearchActivityViewModel::class.java
    }
