...
public abstract class Speedometer extends Gauge {
    ...
    private Paint circleBackPaint = new Paint(Paint.ANTI_ALIAS_FLAG), indicatorLightPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

    private float speedometerWidth = dpTOpx(30f);

    private int markColor = 0xFFFFFFFF, lowSpeedColor = 0xFF00FF00, mediumSpeedColor = 0xFFFFFF00, highSpeedColor = 0xFFFF0000, backgroundCircleColor = 0xFFFFFFFF;

    private int color0_20 =  0xFFFFFFFF, color20_40 =0xFFFFFFFF , color40_60 =0xFFFFFFFF, color60_80 = 0xFFFFFFFF, color80_100 = 0xFFFFFFFF;

    private int startDegree = 135, endDegree = startDegree + 270 ;
    /**
     * to rotate indicator
     */
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        /*   For diPulse   */
        color0_20 = a.getColor(R.styleable.Speedometer_sv_0_20_Color, color0_20);
        color20_40 = a.getColor(R.styleable.Speedometer_sv_20_40_Color, color20_40);
        color40_60 = a.getColor(R.styleable.Speedometer_sv_40_60_Color, color40_60);
        color60_80 = a.getColor(R.styleable.Speedometer_sv_60_80_Color, color60_80);
        color80_100 = a.getColor(R.styleable.Speedometer_sv_80_100_Color, color60_80);
     ...
     *
     * @param note                to display.
     * @param showTimeMillisecond minute to remove Note.
     */
    ...
    /**
     * draw speed eventId at each tick point.
     *
     * @param c canvas to draw.
     */
     ...
     *
     * @param indicator new indicator (Enum eventId).
     */
    ...
    /**
     * @return number of tick points of speed eventId's label.
     */
    ...
    /**
     * to add speed eventId label at each tick point between {@link #maxSpeed}
     * and {@link #minSpeed}.
     *
    ...
    /**
     * to add custom speed eventId label at each tick point between {@link #maxSpeed}
     * and {@link #minSpeed}.
     *
    ...
    /**
     * to make speed eventId's label rotate at each tick.
     *
     ...
     * this option will return {@link #startDegree} to the <b>minimum</b> eventId,
     * and {@link #endDegree} to the <b>maximum</b> eventId
     * if the speedometerMode doesn't equal to {@code Mode.NORMAL}.
     *
     * @param speedometerMode enum eventId.
     */
    ...
    public int getColor0_20() {
        return color0_20;
    }

    public int getColor20_40() {
        return color20_40;
    }

    public int getColor40_60() {
        return color40_60;
    }

    public int getColor60_80() {
        return color60_80;
    }

    public int getColor80_100() {
        return color80_100;
    }
}
