...
//import com.nmesgroup.dipulse.tetra.view.speedviewlib.components.Indicators.NormalIndicator;
...
public class SpeedView extends Speedometer {
    ...
    private static final int SWEEP_ANGLE = 40;
    private static final int DISTANCE_BETWEEN = SWEEP_ANGLE + 15;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getSize() *.5f, getSize() *.5f, getWidthPa()/20f, circlePaint);
    ...
    protected void updateBackgroundBitmap() {
        ...
        // SpeedView Dial changed
        /*speedometerPaint.setColor(getColor0_20());
        c.drawArc(speedometerRect, getStartDegree(), SWEEP_ANGLE, false, speedometerPaint);

        int TEMP_DEGREE = getStartDegree() + DISTANCE_BETWEEN;
        speedometerPaint.setColor(getColor20_40());
        c.drawArc(speedometerRect, TEMP_DEGREE, SWEEP_ANGLE, false, speedometerPaint);

        TEMP_DEGREE = TEMP_DEGREE + DISTANCE_BETWEEN ;
        speedometerPaint.setColor(getColor40_60());
        c.drawArc(speedometerRect, TEMP_DEGREE, SWEEP_ANGLE, false, speedometerPaint);

        TEMP_DEGREE = TEMP_DEGREE + DISTANCE_BETWEEN ;
        speedometerPaint.setColor(getColor60_80());
        c.drawArc(speedometerRect, TEMP_DEGREE, SWEEP_ANGLE, false, speedometerPaint);

        TEMP_DEGREE = TEMP_DEGREE + DISTANCE_BETWEEN ;
        speedometerPaint.setColor(getColor80_100());
        c.drawArc(speedometerRect, TEMP_DEGREE, SWEEP_ANGLE, false, speedometerPaint);*/

        int constantDegree = 54 ;
        speedometerPaint.setColor(getColor80_100());
        c.drawArc(speedometerRect, getStartDegree(),
                getEndDegree()- getStartDegree(), false, speedometerPaint);
        speedometerPaint.setColor(getColor60_80());
        c.drawArc(speedometerRect, getStartDegree()
                , getEndDegree()- getStartDegree() - constantDegree, false, speedometerPaint);
        speedometerPaint.setColor(getColor40_60());
        c.drawArc(speedometerRect, getStartDegree()
                , getEndDegree()- getStartDegree() - constantDegree*2, false, speedometerPaint);
        speedometerPaint.setColor(getColor20_40());
        c.drawArc(speedometerRect, getStartDegree()
                , getEndDegree()- getStartDegree() - constantDegree*3, false, speedometerPaint);
        speedometerPaint.setColor(getColor0_20());
        c.drawArc(speedometerRect, getStartDegree()
                , getEndDegree()- getStartDegree() - constantDegree*4, false, speedometerPaint);

        speedometerPaint.setShadowLayer(12,0,0,Color.parseColor("#d9d9d9"));
        setLayerType(LAYER_TYPE_SOFTWARE, speedometerPaint);
        /*c.drawArc(speedometerRect, getStartDegree(), getEndDegree()- getStartDegree(), false,
                speedometerPaint);*/
        c.save();
