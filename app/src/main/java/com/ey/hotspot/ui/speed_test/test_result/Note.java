...
/**
 * <p>
 * small popup dialog with simple note shown with limited or unlimited minute.
 * </p>
 *
...
public abstract class Note<N extends Note> {
    ...
    /** This eventId used with the {@code speedometer.addNote(Note, int)} property
     ...
     * @param align Enm eventId new dialog Align.
     * @return This Note object to allow for chaining of calls to set methods.
     */
    ...
    /**
     * set dialog position.
     * @param position Enm eventId new Position.
     * @return This Note object to allow for chaining of calls to set methods.
     */
